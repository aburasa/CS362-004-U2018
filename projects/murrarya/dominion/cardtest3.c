...
void testMine() {
	...
	setHand(&G, smithy);
	result = cardEffect(mine, 0, silver, 0, &G, 0, 0);
	...
	result = cardEffect(mine, 0, gold, 0, &G, 0, 0);
	...
	setHand(&G, gold);
	result = cardEffect(mine, 0, copper, 0, &G, 0, 0);
