...
// Assignment 2 card effect function for Adventurer
int effectAdventurer(int currentPlayer, struct gameState *state, int *temphand) {
  int drawntreasure = 0;
  int z = 0;
  int cardDrawn;
...
// Assignment 2 card effect function for Council Room
int effectCouncilRoom(int handPos, int currentPlayer, struct gameState *state) {
  //+4 Cards
  for (int i = 0; i < 4; i++)
  {
    drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return effectAdventurer(currentPlayer, state, temphand);
			
    case council_room:
      return effectCouncilRoom(handPos, currentPlayer, state);
