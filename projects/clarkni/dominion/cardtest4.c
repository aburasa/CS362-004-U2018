/* CS362 - Assignment 3
 * cardtest3.c --> test for card embargo
 */
...
int main(){
    ...
    printf("TEST FOR EMBARGO\n");

    
    cardEffect(embargo, choice1, choice2, choice3, &game, handPosition, &bonus);
    ...
    assertTrue(game.deckCount[player0], originalGame.deckCount[player0] - 2);

    printf("\nPlayer 0 gains 2 actions\n");
    assertTrue(game.numActions, originalGame.numActions);
